...
class FlutterDanmakuBulletManager {
  ...
  // 返回所有的底部弹幕
  List<FlutterDanmakuBulletModel> get bottomBullets => bullets
      .where(
          (element) => element.position == FlutterDanmakuBulletPosition.bottom)
      .toList();
  ...
  // 初始化一个子弹
  FlutterDanmakuBulletModel initBullet(
      ...
      required FlutterDanmakuBulletPosition position,
      Color? color,
